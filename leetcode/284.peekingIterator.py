...
Total Accepted: 32853
Total Submissions: 94201
Difficulty: Medium
Contributors: Admin
...
class PeekingIterator(object):
    ...
    def peek(self):
        ...
        if self.peekElement is None:
            self.peekElement = self.iterator.next()
    ...
    def hasNext(self):
        ...
        :rtype: bool
        """
        return self.peekElement is not None or self.iterator.hasNext()
